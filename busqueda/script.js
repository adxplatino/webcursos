...
document.getElementById('link_button').innerHTML = 'Verificando: ' + (--seconds);
            if (!seconds) {
                ...
                document.getElementById("link_button").innerHTML = '<div class="imps"><a rel="nofollow noreferrer" target="_blank" style="color: white;" href='+resultadoUrl+'><b>CONTINUAR</b></a></div>';
