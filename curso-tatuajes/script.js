...
titulomodal.innerHTML = "CURSO DE TATUAJES</br>LECCIÓN " + [e];

var cuerpomodal = document.getElementById("cuerpomodal");
  cuerpomodal.innerHTML = "<div class='iframe-container'><iframe id='modalVideo' src="+video[e]+" width='100%' height='480' frameborder='0' allowfullscreen></iframe></div></br> <p style='text-align: center'>Curso gratis de Iniciación al Tatuaje.</p> <center><div id='adsContenedor'></div></center></br>";
ads();
}
