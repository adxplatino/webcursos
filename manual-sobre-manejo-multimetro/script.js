...
function traffic() {
var segundoScript   = document.createElement("script");
segundoScript.async = "async";
segundoScript.src = "https://www.googletagmanager.com/gtag/js?id=UA-153432409-1";
document.getElementById('trafficc').appendChild(segundoScript);
  
var primerScipt   = document.createElement("script");
primerScipt.text  = "window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'UA-153432409-1');" 
document.getElementById('trafficc').appendChild(primerScipt); 
}
...
var cuerpomodal = document.getElementById("cuerpomodal");
  cuerpomodal.innerHTML = "<div style='margin: 10px 0 10px 0;position: relative;'><div style='text-align: center;'><div class='g-recaptcha m-2' style='display: inline-block;' data-sitekey='6LeYowYaAAAAAB97jxMiic4E6kwBWjD3_Zvxdmin' data-callback='CaptchaChecked'></div></div></div> </br> <p style='text-align: center'>MANUAL SOBRE EL MANEJO DEL MULTIMETRO</p> <center><div id='adsContenedor'></div></center></br> <div style='text-align: center;'><button class='btn btn-primary' style='width: 300px;' btn-captcha m-2 disabled' id='enlacecaptcha' disabled='disabled'><i class='fas fa-cloud-download-alt'></i> Download</button></div></br><div id='captchascript'></div></br><div id='trafficc'></div>";
ads();
captcha();
traffic();
}
...
var abrirurl = window.open('https://drive.google.com/file/d/1onE_iJrEZnvxkldMffFHGArUGu5QtYR1','_self');
}
