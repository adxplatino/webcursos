...
document.getElementById('link_button').innerHTML = 'Video en: ' + (--seconds);
            if (!seconds) {
                ...
                document.getElementById("link_button").innerHTML = '<a rel="nofollow noreferrer" target="_blank" style="color: white;" href="https://www.youtube.com/watch?v=sLIl96xRZFo">VER VIDEO</a>';
