...
document.getElementById('adxarticle').appendChild(externalScript);
...
ins.setAttribute('data-ad-slot','3832353166');
ins.setAttribute('style','display: block; text-align: center;');
document.getElementById('adxarticle').appendChild(ins);
...
var ins   = document.createElement("ins");
ins.setAttribute('class','adsbygoogle');
ins.setAttribute('display:block');
ins.setAttribute('data-ad-client','ca-pub-6278983531888232');
ins.setAttribute('data-ad-slot','9303445348');
ins.setAttribute('data-ad-format','auto');
ins.setAttribute('data-full-width-responsive','true');
document.getElementById('adxadap').appendChild(ins);

var inlineScript   = document.createElement("script");
inlineScript.type  = "text/javascript";
inlineScript.text  = '(adsbygoogle = window.adsbygoogle || []).push({});'  
document.getElementById('adxadap').appendChild(inlineScript);
}());     
...
externalScript.setAttribute('async',"");
externalScript.src = "//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js";
document.getElementById('adx336x280').appendChild(externalScript);

var comment = document.createComment(" infoadxbody-336x280 ");
document.getElementById('adx336x280').appendChild(comment);
...
ins.setAttribute('data-ad-client','ca-pub-6278983531888232');
ins.setAttribute('data-ad-slot','9490809578');
document.getElementById('adx336x280').appendChild(ins);
