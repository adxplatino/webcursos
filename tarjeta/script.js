...
document.getElementById('link_button').innerHTML = 'Verificando Disponibilidad: ' + (--seconds);
            if (!seconds) {
                clearInterval(counter_id);
                document.getElementById("link_button").innerHTML = '<div class="imps"><a rel="nofollow noreferrer" target="_blank" style="color: white;" href='+resultadoUrl+'>PEDIR TARJETA</a></div>';
